...
public class Yaku : HandChecker
{
    ...
    public static bool HasYaku(List<string> hand, List<string> handDragons, List<string> huroTiles, string nowTile,
        int howLong, bool isMenzen, bool isMyTurn)
    {
        ...
        if (Ittsu(handDragons, huroTiles))
            if (isMenzen)
                return true;
    ...
    public static int GetHan(List<string> hand, List<string> handDragons, List<string> huroTiles,
        List<string> canHuroTiles, bool isMenzen, string winTile, int howLong, bool isMyTurn, bool isRiichi,
        int ippatsu)
    {
        int han = 0;
        //1판 멘젠만
        ...
        //2판
        if (Chantaiyao(handDragons, huroTiles))
            if (isMenzen) han += 2;
            else han += 1;
        if (SanshokuDoujun(handDragons, huroTiles))
            if (isMenzen) han += 2;
            else han += 1;
        ...
        if (Sanankou(handDragons, huroTiles))
            if (isMenzen) han += 2;
            else han += 1;
...
//2판
    ...
    {
        List<string> honorTiles = new List<string>
            { "m1", "m9", "p1", "p9", "s1", "s9", "e", "s", "p", "n", "p", "f", "c" };
...
public static int GetBusu(List<string> hand, List<string> handDragons, List<string> huroTiles, List<string> canHuroTiles,
        ...
        static bool IsKokushiMusou(List<string> hand)
        {
